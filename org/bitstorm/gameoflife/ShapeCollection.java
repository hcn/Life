...
public class ShapeCollection {
  ...
  private static final Shape CAT;
  ...
  static {
    ...
    CAT = new Shape("Cheshire Cat", new int[][] {{2,0}, {5,0},{2,1},{3,1},{4,1},{5,1},{1,2,},{6,2},{1,3},{6,3},{1,4},{3,3},{4,3},{6,4},{2,5},{3,5},{4,5},{5,5}});
    ...
    COLLECTION = new Shape[] {CLEAR, GLIDER, SMALLEXPL, EXPLODER, CELL10, FISH, PUMP, SHOOTER,CAT};
  }
